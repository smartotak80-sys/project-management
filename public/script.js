document.addEventListener('DOMContentLoaded', () => {
  ...
  // --- АДМІНКА: СПИСОК КОРИСТУВАЧІВ (КАРТКИ) ---
  ...
  function updateAuthUI() {
      ...
      if(addBtn && currentUser && currentUser.role !== 'admin' && members.filter(m => m.owner === currentUser.username).length >= MAX_MEMBER_PER_USER) {
